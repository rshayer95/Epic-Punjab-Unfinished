    ...
    if($("#login-form") !== undefined){
        ...
        $("#username").keyup(function(){
            if($(this).val().length == 0){
               ...
               turn_input_icon_to_danger_color($('#user_icon'));
               input_error_msg($('#username_error'),"Please Enter Your Email");  
            } 
            else if($(this).val().length > 3){
               turn_input_color_to_normal_focused($(this));
               turn_input_icon_to_normal_focused($('#user_icon'));
               remove_error_msg($('#username_error'));  
            }    
        ...
        $("#username").blur(function(){
           if($(this).val().length == 0){
               ...
               turn_input_icon_to_normal_color($('#user_icon'));
               remove_error_msg($('#username_error'));  
            }    
